...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->enum('sender' , ['individual', 'company'])->nullable();
            $table->string('recipient_name');
            $table->string('phone1')->nullable();
            $table->string('phone2')->nullable();
            $table->foreignId('dealer_id')->constrained()->nullable();
            $table->foreignId('delegate_id')->constrained()->nullable();
            ...
            $table->enum('shipping_amount' , ['sender', 'receiver'])->nullable();
            $table->string('notes');
